      ...
      <div class="dashboard-wrapper">
        <div class="flex flex-wrap mx-[-15px]">
          <div class="xl:w-12/12 w-full px-[15px]">
                ...
                <div class="card-wrap">
                  ...
                  <div class="content">
                    <form @submit.prevent="handleRecharge">
                      <div class="mb-4">
                        <label class="block text-dark dark:text-white mb-2" for="amount">Enter Amount</label>
                        <input
                          id="amount"
                    ...
                    <div v-if="walletAddress" class="mt-4">
                      <div class="font-bold mb-2">Refund Wallet Address:</div>
                      <div class="bg-gray-100 dark:bg-dark p-2 rounded break-all">{{ walletAddress }}</div>
                    </div>
                    <div v-if="success" class="text-green-600 mt-2">{{ success }}</div>
                    <div class="mt-6">
                      <div class="font-bold">Current Balance:</div>
                      <div class="text-lg">{{ userBalance !== null ? userBalance : 'Loading...' }}</div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <!-- Existing Tools/E-Book/Videos sections below -->
          </div>
        </div>
      </div>
    </div>
